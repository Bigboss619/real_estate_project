...
<?php
    if(isset($_POST['form_reset_password']))
    {
        try {
                ...
                $statement = $conn->prepare("UPDATE customer SET token=?, password=? WHERE email=? AND token=?");
                ...
                header('location: '.BASE_URL.'customer-login?msg=success');
                exit;
        } catch (Exception $e) {
                    ...
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        <div class="card card-primary border-box">
                            <div class="card-header card-header-auth">
                                <h4 class="text-center">Customer Reset Password</h4>
                            </div>
