                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group row bdb1 pt_10 mb_0">
                                    <div class="col-md-4"><label class="form-label"> Allowed Features Properties</label></div>
                                    <div class="col-md-8">
                                    <?php if($row['allowed_feature_properties'] == '-1'): ?>
                                            Unlimited
                                            <?php else: ?>
                                        <?php echo $row['allowed_feature_properties'] ?>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group row bdb1 pt_10 mb_0">
                                    <div class="col-md-4"><label class="form-label"> Allowed Photo</label></div>
                                    <div class="col-md-8">
                                    <?php if($row['allowed_photo'] == '-1'): ?>
                                            Unlimited
                                            <?php else: ?>    
                                    <?php echo $row['allowed_photo'] ?>
                                    <?php endif; ?>
                                </div>
                                </div>
                                <div class="form-group row bdb1 pt_10 mb_0">
