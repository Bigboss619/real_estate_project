                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <?php
                                    $i=0;
                                    $statement = $conn->prepare("SELECT w.id as wishlist_id, w.customer_id, w.property_id, p.name, p.price, p.slug, p.id as p_id
                                     FROM wishlist w
                                    JOIN property p
                                    ...
                                    <td>
                                        <a href="<?php echo BASE_URL; ?>single-property/<?php echo $row['p_id']; ?>/<?php echo $row['slug']; ?>" class="btn btn-primary btn-sm text-white"><i class="fas fa-eye"></i></a>
